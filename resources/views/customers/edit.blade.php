    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600">Modifica la información de {{ $customer->name }}</p>
            </div>
            <div class="flex space-x-3">
                <a href="{{ route('customers.show', $customer) }}" class="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-lg flex items-center">
    ...
    <div class="bg-white shadow rounded-lg">
        <form method="POST" action="{{ route('customers.update', $customer) }}" class="p-6 space-y-6">
            ...
            <div class="border-b border-gray-200 pb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="document_number" class="block mt-1 w-full" type="text" name="document_number" :value="old('document_number', $customer->document_number)" />
            ...
            <div class="border-b border-gray-200 pb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="zip" class="block mt-1 w-full" type="text" name="zip" :value="old('zip', $customer->zip)" />
            ...
            <div class="flex justify-end space-x-4">
                <a href="{{ route('customers.show', $customer) }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 px-6 py-2 rounded-lg">
                    Cancelar
                </a>
