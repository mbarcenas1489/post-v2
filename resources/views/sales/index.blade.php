<x-app-layout>
    ...
    <div class="mb-6 flex justify-between items-center">
        <div>
            ...
            <p class="text-gray-600">Administra las ventas del sistema</p>
        </div>
        <a href="{{ route('sales.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg flex items-center">
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-12 text-center text-gray-500">
                                ...
                                <p class="mt-1 text-sm text-gray-500">Comienza registrando una nueva venta.</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
