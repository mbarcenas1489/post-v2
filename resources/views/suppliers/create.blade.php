<x-app-layout>
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Crear Nuevo Proveedor</h1>
                <p class="text-gray-600">Agrega un nuevo proveedor a tu base de datos</p>
            </div>
    ...
    <div class="bg-white shadow rounded-lg">
        <form method="POST" action="{{ route('suppliers.store') }}" class="p-6 space-y-6">
            ...
            <div class="flex justify-end space-x-4">
                <a href="{{ route('suppliers.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 px-6 py-2 rounded-lg">
                    Cancelar
                </a>
